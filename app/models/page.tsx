...
export default function ModelsPage(){
 return <main className="shell modelsPage">
  <nav className="nav"><a className="brand" href="/">FinLLM <i>Atlas</i></a><div className="atlasTabs" role="navigation" aria-label="Atlas 主视图"><a href="/models" className="active" aria-current="page">金融大模型图谱</a><a href="/">金融 Eval 图谱</a></div><div className="navlinks utilityLinks"><a href="/general">通用 Agent ↗</a><a className="github" href="https://github.com/yuedai-pbc/FinEval-Atlas" target="_blank" rel="noreferrer">GitHub ↗</a></div></nav>
